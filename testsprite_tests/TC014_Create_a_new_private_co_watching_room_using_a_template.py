...
async def run_test():
    ...
    try:
        ...
        # -> Retry logging in by clicking the 'Sign In' button (index 658) to attempt login again.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/main/div[6]/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        ...
        assert await frame.locator("xpath=//*[contains(., 'Invite code')]").nth(0).is_visible(), "Expected 'Invite code' to be visible"
