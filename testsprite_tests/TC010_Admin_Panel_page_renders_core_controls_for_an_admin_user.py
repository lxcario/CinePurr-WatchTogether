...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /admin (http://localhost:3000/admin) to check whether the Admin panel is reachable and then verify presence of 'Admin' in title and 'Maintenance' and 'Broadcast' UI text.
        await page.goto("http://localhost:3000/admin")
        
        # -> Navigate explicitly to /admin (http://localhost:3000/admin) to inspect the admin panel page content and check for 'Admin' in the title and 'Maintenance'/'Broadcast' UI text.
        await page.goto("http://localhost:3000/admin")
