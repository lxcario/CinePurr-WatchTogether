...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username field (index 555) with 'Lucario' as the next immediate action.
        ...
        # -> Retry login by clicking the 'Sign In' button (index 561), then wait/observe whether the app navigates to '/room'.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[3]/main/div[6]/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
