...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (explicit navigate to https://cinepurr.me/login as requested)
        ...
        # -> Retry signing in by clicking the 'Sign In' button again to attempt to reach /room. If login still fails, report the issue and stop.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[3]/main/div[6]/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
