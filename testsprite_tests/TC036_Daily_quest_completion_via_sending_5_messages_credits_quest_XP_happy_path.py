...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided username and password into the Sign In form and submit (click Sign In).
        ...
        # -> Retry sign in by clicking the 'Sign In' button again to attempt login.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/main/div[6]/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Navigate to /room (explicit test step). Attempt to reach the room page so the chat message can be sent and quest behavior verified.
        await page.goto("https://cinepurr.me/room")
        
        # --> Assertions to verify final state
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Quest msg 1')]").nth(0).is_visible(), "Expected 'Quest msg 1' to be visible"
