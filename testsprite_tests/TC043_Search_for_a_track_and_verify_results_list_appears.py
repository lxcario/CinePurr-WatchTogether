...
async def run_test():
    ...
    try:
        ...
        # -> Type the username into the username field (index 620).
        ...
        assert await frame.locator("xpath=//*[contains(., 'Mini music player')]").nth(0).is_visible(), "Expected 'Mini music player' to be visible"
        assert await frame.locator("xpath=//*[contains(., 'Search results')]").nth(0).is_visible(), "Expected 'Search results' to be visible"
        assert await frame.locator("xpath=//*[contains(., 'Track result item')]").nth(0).is_visible(), "Expected 'Track result item' to be visible"
